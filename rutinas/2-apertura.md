...
PRIMERO lee y sigue `CLAUDE.md`, y lee `memory/estrategia.md`, `memory/guardarrailes.md`, `memory/watchlist.md`, `memory/diario_operaciones.md`. Las **ideas del día NO están en un `.md`** (ese no se actualiza en la nube): vienen del **Google Sheet** (ver paso 1).
